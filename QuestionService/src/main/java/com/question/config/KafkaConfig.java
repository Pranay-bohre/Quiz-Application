...
public class KafkaConfig {
    ...
    @Bean
    public ConsumerFactory<String, QuestionRequestEvent> consumerFactory() {
        ...
        // Tell it what type to deserialize into
        props.put(JsonDeserializer.VALUE_DEFAULT_TYPE, "com.question.dto.QuestionRequestEvent");
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, QuestionRequestEvent> kafkaListenerContainerFactory() {
